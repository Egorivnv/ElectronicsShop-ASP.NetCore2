    ...
    public class AdminControllerTests
    {
        ...
        public void Index_Contains_All_Products()
        {
            ...
            mockCategory.Setup(m => m.Categories).Returns(new Category[] {
                new Category {CategoryID = 1, Name = "C1", Brands = { } },
                new Category {CategoryID = 2, Name = "C2", Brands={} },
                new Category {CategoryID = 3, Name = "C3", Brands = {} },
                }.AsQueryable<Category>());
            // Arrange - create a controller
            AdminController target = new AdminController(mock.Object, mockCategory.Object);
            // Action
